...
$u = Auth::user();
$nome  = htmlspecialchars($u['nome']  ?? 'Administrador', ENT_QUOTES, 'UTF-8');
...
<aside class="sidebar-sticky">
  ...
  <div class="list-group shadow-sm">
    ...
    <a href="<?= Url::to('/admin/mensagens') ?>" class="list-group-item list-group-item-action <?= Url::is('/admin/mensagens') ? 'active' : '' ?>">
    ...
    <a href="<?= Url::to('/admin/configuracoes') ?>" class="list-group-item list-group-item-action <?= Url::is('/admin/configuracoes') ? 'active' : '' ?>">
