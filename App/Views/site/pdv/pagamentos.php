            ...
            <div class="container-fluid">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 w-100">
                    <div class="d-flex align-items-baseline gap-2">
                        ...
                        <span class="nav-brand-sub">&bull; Pagamentos</span>
                    </div>
            ...
            <div class="pagamentos-grid">
                <section class="panel painel-pagamentos-form">
                    <div class="panel-soft p-3">
                        <div class="panel-title-sm mb-3 text-uppercase">Cadastrar pagamento</div>
                    ...
                    <div class="panel-soft p-3 mt-3 flex-grow-1">
                        <div class="panel-title-sm mb-2 text-uppercase">Pagamentos adicionados</div>
                ...
                <aside class="panel painel-pagamentos-resumo">
                    <div class="panel-soft p-3">
                        <div class="panel-title-sm mb-2 text-uppercase">Totais por forma</div>
                    ...
                    <div class="panel-soft p-3 mt-3">
                        <div class="panel-title-sm mb-2 text-uppercase">Resumo financeiro</div>
                    ...
                    <div class="panel-soft p-3 mt-3">
                        <div class="d-grid gap-2">
                            <button class="btn btn-outline-light" id="btnPreviewResumo" type="button">Pre-visualizar
                                cupom</button>
