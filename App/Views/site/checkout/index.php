              ...
              <div class="card shadow-sm mb-3">
                <div class="card-body">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="entrega" id="entrega_retirada"
                      value="retirada" checked>
                    <label class="form-check-label" for="entrega_retirada">Retirar na loja</label>
                  </div>
                  <div class="form-check mt-2">
                    <input class="form-check-input" type="radio" name="entrega" id="entrega_entrega"
                      value="entrega">
              ...
              <div class="card shadow-sm mb-3" id="card-enderecos">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="h6 text-uppercase text-muted mb-0">Endereço de entrega</h2>
                    <a href="<?= \App\Core\Url::to('/conta/enderecos/novo') ?>"
                      ...
                      ?>
                        <div class="col">
                          <label class="border rounded p-3 d-flex address-card">
                            <input type="radio" class="form-check-input me-3" name="endereco_id"
                            ...
                            <div>
                              ...
                              <?php endif; ?>
                              <div><?= $h($endereco['logradouro'] ?? '') ?>,
                                <?= $h($endereco['numero'] ?? '') ?>
                                <?= $h($endereco['complemento'] ?? '') ?></div>
                              <div><?= $h($endereco['bairro'] ?? '') ?> -
                                <?= $h($endereco['cidade'] ?? '') ?>/<?= $h($endereco['uf'] ?? '') ?>
                              </div>
                  ...
                  <?php else: ?>
                    <div class="alert alert-warning mb-0">
                      ...
                      <a href="<?= \App\Core\Url::to('/conta/enderecos/novo') ?>"
                        class="alert-link">Adicionar agora</a>.
                    </div>
                  <?php endif; ?>
                </div>
              </div>
                  ...
                  <div class="row row-cols-1 row-cols-sm-2 g-3">
                    <div class="col">
                      <label class="border rounded p-3 w-100">
                        <input class="form-check-input me-2" type="radio" name="pagamento"
                          value="na_entrega" checked>
                        Dinheiro na entrega
                      </label>
                    </div>
                    <div class="col">
            ...
            <div class="col-12 col-lg-4 checkout-summary">
              <div class="card shadow-sm">
                <div class="card-body">
                      ...
                      <tbody>
                        <?php foreach ($linhas as $linha): ?>
                          <tr>
                            ...
                            <td class="text-end">R$
                              <?= number_format($linha['preco'], 2, ',', '.') ?></td>
                            <td class="text-end">R$
                              <?= number_format($linha['subtotal'], 2, ',', '.') ?></td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
                  ...
                  <div class="text-muted small">Frete e descontos ser&atilde;o calculados na
                    confirma&ccedil;&atilde;o.</div>
