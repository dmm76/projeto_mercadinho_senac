...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .invoice { box-shadow: none; border-radius: 0; margin: 0; }
...
<div class="invoice">
    <div class="d-flex justify-content-between align-items-start mb-4">
        ...
        <div class="text-end">
            <span class="badge badge-status <?= htmlspecialchars((string)$statusInfo['class'], ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="small text-muted">
        Esta nota serve como comprovante simplificado do pedido. Para mais detalhes acesse a area "Meus Pedidos" no site.
    </div>
</div>
