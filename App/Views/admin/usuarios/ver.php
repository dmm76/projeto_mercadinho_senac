                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h1 class="h4 mb-0">Usuário #<?= (int)($usuario['id'] ?? 0) ?></h1>
                            <div class="d-flex gap-2">
                                <a href="<?= Url::to('/admin/usuarios/editar') . '?id=' . (int)($usuario['id'] ?? 0) ?>"
                            ...
                            <div class="card-body">
                                <dl class="row mb-0">
                                    ...
                                    <dd class="col-sm-9"><span
                                            class="badge text-bg-secondary text-uppercase"><?= $h($usuario['perfil'] ?? '-') ?></span>
                                    </dd>
