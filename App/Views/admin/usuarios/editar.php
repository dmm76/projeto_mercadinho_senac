                            ...
                            <div class="card-body">
                                <form method="post" action="<?= Url::to('/admin/usuarios/editar') ?>" class="row g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input id="u-nome" name="nome" type="text" class="form-control"
                                            value="<?= $h($usuario['nome'] ?? '') ?>" required>
                                    </div>

                                    <div class="col-12 col-md-6">
                                        <label for="u-email" class="form-label">E-mail</label>
                                        <input id="u-email" name="email" type="email" class="form-control"
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select id="u-perfil" name="perfil" class="form-select" required>
                                            ...
                                            <option value="<?= $valor ?>"
                                                <?= $valor === $perfilAtual ? ' selected' : '' ?>><?= $label ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>

                                    <div class="col-12 col-md-6"><span class="form-label d-block">Status</span>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="u-ativo"
                                                name="ativo" <?= $ativo ? 'checked' : '' ?>>
