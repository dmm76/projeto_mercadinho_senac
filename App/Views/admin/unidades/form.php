...
<form method="post" action="<?= $action ?>">
  ...
  <div class="mb-3"><label class="form-label" for="unidade-sigla">Sigla (UN, KG, L...)</label>
    <input id="unidade-sigla" class="form-control" type="text" name="sigla" required value="<?= $isEdit? htmlspecialchars($unidade->sigla):'' ?>">
  </div>
  <div class="mb-3"><label class="form-label" for="unidade-descricao">Descricao</label>
