...
INSERT INTO `contato_mensagens` (`id`, `nome`, `email`, `mensagem`, `resposta`, `status`, `ip`, `user_agent`, `criada_em`, `respondida_em`) VALUES
	...
	(3, 'Valdir Mendonça', 'valdir@email.com', 'Teste de envio 17 as 18horas', 'teste ok', 'respondida', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:142.0) Gecko/20100101 Firefox/142.0', '2025-09-17 21:21:13', '2025-09-17 21:51:22');
...
INSERT INTO `estoque` (`id`, `produto_id`, `quantidade`, `minimo`, `atualizado_em`) VALUES
	...
	(26, 26, 90.000, 100.000, '2025-09-18 18:07:06'),
	...
	(35, 35, 180.000, 25.000, '2025-09-17 18:36:25'),
	(36, 36, 60.000, 8.000, '2025-09-17 18:36:25'),
	...
	(45, 45, 75.000, 10.000, '2025-09-17 18:38:08'),
	(46, 46, 88.000, 12.000, '2025-09-17 23:00:22'),
	(47, 47, 76.000, 12.000, '2025-09-18 17:58:11');
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Itens de pedido';

-- Copiando dados para a tabela mercadinho.item_pedido: ~21 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Movimentações de estoque';
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Pedidos da loja (online/retirada)';

-- Copiando dados para a tabela mercadinho.pedido: ~9 rows (aproximadamente)
INSERT INTO `pedido` (`id`, `cliente_id`, `endereco_id`, `status`, `entrega`, `pagamento`, `subtotal`, `frete`, `desconto`, `total`, `codigo_externo`, `criado_em`, `atualizado_em`) VALUES
	(1, 5, 1, 'cancelado', 'entrega', 'pix', 120.00, 10.00, 0.00, 130.00, 'PED-0001', '2025-09-13 02:38:18', '2025-09-17 16:57:41'),
	(2, 2, NULL, 'cancelado', 'retirada', 'pix', 123.99, 0.00, 0.00, 123.99, NULL, '2025-09-16 23:33:56', '2025-09-17 23:25:20'),
	(3, 2, NULL, 'pronto', 'retirada', 'na_entrega', 50.00, 0.00, 0.00, 50.00, NULL, '2025-09-16 23:35:06', '2025-09-17 23:55:27'),
	(4, 2, 1, 'em_transporte', 'entrega', 'na_entrega', 120.00, 0.00, 0.00, 120.00, NULL, '2025-09-16 23:45:10', '2025-09-17 23:14:06'),
	(5, 2, NULL, 'cancelado', 'retirada', 'na_entrega', 50.00, 0.00, 0.00, 50.00, NULL, '2025-09-17 00:08:49', '2025-09-17 23:26:41'),
	(6, 5, NULL, 'em_transporte', 'retirada', 'na_entrega', 14.16, 0.00, 0.00, 14.16, NULL, '2025-09-17 01:11:07', '2025-09-17 16:57:30'),
	(7, 2, 1, 'em_transporte', 'entrega', 'na_entrega', 73.80, 0.00, 0.00, 73.80, NULL, '2025-09-17 21:50:17', '2025-09-17 21:50:55'),
	(8, 2, 3, 'novo', 'entrega', 'gateway', 67.81, 0.00, 0.00, 67.81, NULL, '2025-09-17 23:00:22', '2025-09-17 23:00:22'),
	(9, 6, NULL, 'pronto', 'retirada', 'pix', 63.60, 0.00, 0.00, 63.60, NULL, '2025-09-18 17:58:11', '2025-09-18 18:04:20'),
	(10, 2, NULL, 'novo', 'retirada', 'gateway', 10.98, 0.00, 0.00, 10.98, NULL, '2025-09-18 18:05:00', '2025-09-18 18:05:00'),
	(11, 2, NULL, 'novo', 'retirada', 'pix', 8.49, 0.00, 0.00, 8.49, NULL, '2025-09-18 18:59:18', '2025-09-18 18:59:18');
...
INSERT INTO `usuario` (`id`, `nome`, `email`, `senha_hash`, `perfil`, `ativo`, `criado_em`) VALUES
	...
	(3, 'Douglas', 'douglas.monquero@gmail.com', '$2y$10$C3CTohQJfarGZZt9I1ZSs.Vde/Tbz1Y8GKsDAgFqHOBYh3esqSlYm', 'admin', 1, '2025-09-10 22:45:37'),
