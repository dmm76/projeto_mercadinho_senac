...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Categorias do catálogo';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `categoria` VALUES (1,'Mercearia','mercearia',1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Estoque atual por produto (1:1)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Marcas dos produtos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `marca` VALUES (1,'Genérica'),(2,'Tio João');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Histórico de preços por produto';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `preco` VALUES (1,1,50.00,NULL,NULL,NULL,'2025-09-13 03:27:42'),(2,2,20.00,NULL,NULL,NULL,'2025-09-13 03:27:42'),(3,3,5.99,3.99,NULL,NULL,'2025-09-16 23:32:39');
...
INSERT INTO `produto` VALUES (1,'Arroz Tio João 5kg Tipo 1','ARROZ5','789000000001',1,1,1,'Pacote 5kg',NULL,1,0,'2025-09-13 03:26:58'),(2,'Feijão Carioca 1kg','FEIJAO1','789000000002',1,1,1,'Pacote 1kg',NULL,1,0,'2025-09-13 03:26:58'),(3,'Banana Prata','bananaprta',NULL,1,1,2,'banana prata','uploads/produtos/2ed867725ad5057d-1758065559.png',1,0,'2025-09-16 23:32:39');
...
INSERT INTO `unidade` VALUES (1,'UN','Unidade'),(2,'KG','Quilo'),(3,'G','Gramas');
